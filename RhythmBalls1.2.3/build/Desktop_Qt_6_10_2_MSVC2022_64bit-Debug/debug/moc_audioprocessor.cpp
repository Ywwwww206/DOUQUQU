...
void AudioProcessor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->beatDetected((*reinterpret_cast<std::add_pointer_t<float>>(_a[1]))); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        if (QtMocHelpers::indexOfMethod<void (AudioProcessor::*)(float )>(_a, &AudioProcessor::beatDetected, 0))
            return;
    }
}
...
// SIGNAL 0
void AudioProcessor::beatDetected(float _t1)
{
